...
#dtu_scenes = ['scan63'] #下一个跑97
#dtu_scenes = ['scan37','scan63','scan65', 'scan97', 'scan110']  ##高光场景，也是大家效果都很差的场景
parser = ArgumentParser(description="Full evaluation script parameters")
parser.add_argument("--skip_training", action="store_true") ##指定了就是true
...
if not args.skip_metrics:
    ...
    ##python scripts/eval_dtu/evaluate_single_scene.py  --input_mesh 